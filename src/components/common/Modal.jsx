...
export const Modal = (props) => {
  return (
    <Show when={props.open}>
      <Portal>
        <div
          class="fixed inset-0 bg-black/60 z-50 flex items-center justify-center text-white font-mono"
        ...
        >
          ...
          >
            <div class="flex items-center justify-between p-6">
              ...
              <button onClick={props.onClose} class="p-2 hover:bg-white/10 rounded" aria-label="Close">
                <X size={18} />
              </button>
            </div>
